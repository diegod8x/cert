...
class CertEmpresasSetPruebasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'respuesta_envio' => ['type' => 'string', 'length' => 1000, 'null' => true, 'default' => null, 'collate' => 'latin1_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'xml_envio' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'latin1_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_indexes' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'xml_envio' => 'Lorem ipsum dolor sit amet'
            ],
        ];
        parent::init();
    }
